"""Draw 5 random articles per outlet from articles_clean.jsonl for post-cleaning audit."""
...
SEED = 99  # different from blacklist sample seed (42)
N = 5
OUT_DIR = ANALYSIS / "audit_samples"
