"""Draw 5 random articles per outlet from articles_clean.jsonl for third audit pass (seed=7)."""
...
SEED = 7  # distinct from seed=42 (Step4) and seed=99 (Step4b)
N = 5
OUT_DIR = ANALYSIS / "audit_samples_v2"
OUT_DIR.mkdir(parents=True, exist_ok=True)


def main() -> None:
    by_source: dict[str, list[dict]] = {}
    for row in read_jsonl(PROCESSED / "articles_clean.jsonl"):
